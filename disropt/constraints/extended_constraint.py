...
class ExtendedConstraint(Constraint):
    ...
    def __new__(cls, constr: Union[Constraint, list], n_var: int=1, axis=-1):
        ...
        if isinstance(constr, Constraint):
            ...
            return Constraint(ExtendedFunction(constr.fn, n_var, axis), constr.sign)
        else:
            return [ExtendedConstraint(x, n_var, axis) for x in constr]